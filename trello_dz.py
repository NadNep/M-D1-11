...
def auth_data():
    your_key = input("Введите ваш Trello API key: ")
    your_token = input("Введите ваш Trello API token: ")
    your_b_id = input("Введите КОРОТКИЙ id вашей доски: ")
    return your_key, your_token, your_b_id

your_key, your_token, your_b_id = auth_data()
